...
class Debugpage extends Component
{
    ...
    export_csv(event)
    {
        ...
        else
        {
            ...
            axios.post(window.customVars.urlPrefix+window.customVars.apiGetStatJSON,postData,axiosConfig)
                .then(res => {
                    ...
                    {
                        var JSONData = res.data.result;
                        var fileName = "Chips Info";
    ...
    render()
    {
        const { isLoaded, redirectToIndex,redirectToLogin,boards,hashes,show_nonce,show_chip_reject,exporting } = this.state;
        if (redirectToLogin)
        {
                        ...
                        <div className="box">
                            <div className="box-header">
                                <div className="row">
                                    ...
                                    <div className="col-md-9 pull-right pr-lg-5">
                                        <button disabled={exporting} className="btn btn-primary" onClick={this.export_csv}>Export Chips Info{exporting && <div className="btn-loader lds-dual-ring"></div>}</button>
                                    </div>
                                </div>
                            </div>
